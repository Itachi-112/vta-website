 ...
 * * Props:
 * - phoneNumber: The target phone number (include country code, e.g., '15551234567')
...
const WhatsAppButton = ({ 
  ...
  // Show button after a slight delay for better UX animation
  useEffect(() => {
  ...
  return (
    ...
    >
      {/* Tooltip / Helper Text */}
      <div 
        className={`bg-white text-gray-800 px-4 py-2 rounded-lg shadow-xl mb-2 transition-all duration-300 origin-bottom-right border border-gray-100 ${
          isHovered ? 'opacity-100 scale-100' : 'opacity-0 scale-90 pointer-events-none'
        }`}
      >
        <p className="text-sm font-semibold">Chat with {accountName}</p>
      ...
      <a
        ...
        className="group relative flex items-center justify-center w-16 h-16 bg-[#20bd5a] rounded-full shadow-lg hover:shadow-2xl hover:bg-[#20bd5a] transition-all duration-300 hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-green-300"
